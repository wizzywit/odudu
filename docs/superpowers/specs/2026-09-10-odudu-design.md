...
| P2a | Identity model: roles, groups, client scopes, web origins, email | 70–100 h  | realm and client roles, composite roles, groups and client scopes emitted into tokens; per-client web origins so a browser client completes the flow; email delivered, with address verification on top of it                                                |
