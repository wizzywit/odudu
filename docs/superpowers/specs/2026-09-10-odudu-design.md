...
| P10 | Extensibility: third-party providers                             | 40–65 h   | a third-party provider loads without a rebuild; a claim mapper an operator supplies loads the same way, so the registry P4c lets a tenant rebind can also be extended — `standardClaimMappers` and the role and group mappers beside it are the whole vocabulary today, and nothing a tenant writes can add to it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
Total: roughly 1375–2040 hours.

After P4b, at roughly 740–1055 hours, an application can adopt Odudu: every
...
until P4c shipped, and **means P4e** now that it has, unless it concerns
token exchange, the grant allowlist, the admin API, the consoles, theming or
client branding.
