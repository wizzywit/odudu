...
| 3.1.2.1 | MUST   | with `prompt=none`, an error is returned if the client lacks pre-configured consent for the requested claims                                                                                                                                                                                   | `OIDC-CORE-3.1.2.1-12` | covered                                                                                                                                                                                                                                                                                                                               |
...
| 3.1.2.4 | MUST   | once authenticated, the authorization server obtains an authorization decision before releasing information to the client                                                                                                                                                                      | `OIDC-CORE-3.1.2.4-01` | covered                                                                                                                                                                                                                                                                                                                               |
...
| 16.18   | SHOULD | the authorization server clearly identifies long-term grants to the user during authorization                                                                                                                                                                                                  | `OIDC-CORE-16.18-01`   | covered                                                                                                                                                                                                                                                                                                                               |
