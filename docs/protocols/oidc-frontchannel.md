...
| 2      | SHOULD | `frontchannel_logout_session_required` is also registered                                                                       | —                                 | deferred: P3b — neither a schema column nor a `parseClientMetadata` field for it exists yet                                                                                                      |
