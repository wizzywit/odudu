...
// These pages are markup only — no script, stylesheet, image or frame of
// their own — so `default-src 'none'` describes them exactly and a
// subresource added later breaks visibly. X-Frame-Options: DENY rides
